...
const StaffJobAddView = () => {
  ...
  useEffect(() => {
    const fetchGroupEmails = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/staff/getfeedgroupmail`, { withCredentials: true });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${BASE_URL}/staff/createjobs`, [formattedData], { withCredentials: true });
      setFormData({ 
        companyName: '', 
        jobDescription: '', 
        driveDate: '', 
