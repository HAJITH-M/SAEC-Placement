...
const StaffManagementView = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-3 lg:p-6 min-h-screen">
      {/* Header Section */}
      <div className="relative flex items-center justify-between mb-3 lg:mb-8">
        {viewMode && (
          <button
            onClick={handleBack}
            className="group flex cursor-pointer items-center gap-5 px-4 py-2 text-white rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-orange-300"
          >
            <ArrowLeft
              size={20}
              className="group-hover:-translate-x-1 transition-transform text-stone-800 cursor-pointer"
            />
